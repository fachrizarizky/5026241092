...
<body>
    ...
    <div class="container">
        <div class="mt-4 p-5 bg-primary text-white rounded">
            <h3>5026241092 Fachriza Rizky Susanto</h3>
            <h6>@yield('title')</h6>
        </div>
        <nav class="navbar navbar-expand-sm bg-light navbar-light">
            <div class="container-fluid">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/keranjangbelanja">PR 2 (Latihan EAS Cowok)</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/nilaikuliah">PR 3 (Latihan EAS Cewek)</a>
                    </li>
                    <li class="nav-item">
